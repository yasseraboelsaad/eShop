				...
				<div class="col-md-12">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="fname" class="form-control" id="inputEmail3" />
							</div>
						</div>
						<label for="inputLname3" class="col-sm-2 control-label">
							...
							<div class="col-sm-10">
								<input type="lname" class="form-control" id="inputEmail3" />
							</div>
						</div>
							<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="Cpassword" class="form-control" id="inputPassword3" />
							</div>
							<div class="form-group">
